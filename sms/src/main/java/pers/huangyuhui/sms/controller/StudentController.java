...
public class StudentController {
    ...
    public Map<String, Object> uploadPhoto(MultipartFile photo, HttpServletRequest request) {
        final String DIR_PAHT = request.getServletContext().getRealPath("/upload/student_portrait/");//存储头像的本地目录
        final String PORTRAIT_PATH = request.getServletContext().getContextPath() + "/upload/student_portrait/";//存储头像的项目发布目录
